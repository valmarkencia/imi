	...
	<div class="white clients">
		<div class="container">
			...
			<ul style="list-style: none;">
				...
				<li>PAGCOR Networld Hotel and Casino</li>
				<li>PAGCOR Orient Pearl Casino, Pasay City</li>
				<li>PAGCOR Orient Pearl Casino, Subic Bay</li>
				<li>Shangri-la Hotel at The Fort</li>
				<li>The Westin - Manila Sonata Place</li>
			</ul>
		</div>
	</div>
</div>
